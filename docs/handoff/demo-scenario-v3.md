...
```
지민: "다들 시험 끝나고 한번 보자!"
수현: "5/8 금요일은 동아리 MT라 안 되고, 5/13·5/14·5/15·5/16도 시험 기간이라 다 안 돼. 다음주 5/19·5/20도 발표 준비 때문에 일정 잡혀있어"
민수: "9일은 본가 내려가야 해서 패스"
예린: "10일 토요일은 좀 쉬고 싶다… 다음주도 사실 5/11 빼고 다 바빠"
```

> **D-1 보강 (QA v3 권고)**: 수현 발화에 5/19·5/20을 추가해 28일 확장 후에도 `busy_by_user` non-empty가 보장되도록 함 → ACT 2.5 `majority_fallback` 자연 발동 안정성 ↑.
