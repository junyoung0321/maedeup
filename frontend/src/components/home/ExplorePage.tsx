...
export default function ExplorePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto px-4 sm:px-8 lg:px-[55px] py-6 sm:py-8 flex flex-col gap-6 sm:gap-10">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-t border-[#e2e8f0]">
        <div className="mx-auto px-4 sm:px-8 lg:px-[55px] py-3 sm:py-4 flex flex-col sm:flex-row sm:justify-end gap-2 sm:gap-4 lg:gap-6">
          <button
