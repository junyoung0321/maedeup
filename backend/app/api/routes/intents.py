...
_SEED_EXAMPLES: list[tuple[str, str]] = [
    ...
    ("역삼동에서 만나자", "place_suggestion"),
    ("서초동 카페 어때", "place_suggestion"),
    ("신촌에서 볼까?", "place_suggestion"),
    ("건대 맛집 추천", "place_suggestion"),
    ("잠실 근처 어때?", "place_suggestion"),
    ("이태원에서 먹자", "place_suggestion"),
    ("압구정 가자", "place_suggestion"),
    ("합정역 근처로 하자", "place_suggestion"),
    ("판교에서 만나자", "place_suggestion"),
    ("종로 쪽 어떨까", "place_suggestion"),
    ("을지로 맛집 알아?", "place_suggestion"),
    ("삼성동 카페 ㄱㄱ", "place_suggestion"),
    ("역삼역 근처 식당", "place_suggestion"),
    ("홍대입구역 근처", "place_suggestion"),
    ("강남역 맛집", "place_suggestion"),
    ("신림동 고기집", "place_suggestion"),
    ("여의도에서 먹자", "place_suggestion"),
    ("성수동 카페 가보자", "place_suggestion"),
    # general ──────────────────────────────────────────────────
    ("밥 먹었어?", "general"),
    ("오늘 뭐해?", "general"),
    ("요즘 어때?", "general"),
